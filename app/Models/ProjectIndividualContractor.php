...
class ProjectIndividualContractor extends Model
{
    use HasFactory,SoftDeletes;
    protected $fillable = [
        'name', 'user_id','project_id', 'project_type_id', 'property_type_id', 'budget_range_id', 'start_date', 'handover_date', 'description', 'project_status',
        'budget_min', 'budget_max','live_at','property_other'
    ];
    protected $appends = ['project_status_text','meet_count','type'];

    protected function type(): Attribute
    {
        return Attribute::make(
            get: fn ($value) => 'individual',
        );
    }
    ...
    public function getMeetCountAttribute()
    {
        return 0;
    }
