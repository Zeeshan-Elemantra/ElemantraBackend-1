...
class ProjectIndividualRequestAdd extends FormRequest
{
    ...
    {
        $rule = [
            'project_id'=>['required','exists:project_individual_contractors,id'],
            ...
            'other_item_brand_specification'=>['nullable','string'],
