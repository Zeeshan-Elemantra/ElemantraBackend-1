...
$(document).ready(function(){
    ...
    $("#addForm").submit(function(e) {
    	...
    	$.ajax({
		type: "POST",
		url: "actions/main_categories/add.php",
		data: formData,
    ...
    $("#tableContainer").on("click",".edit-element",function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "actions/main_categories/get.php",
            data: {'id':id},
            success: function(obj) {
                //alert(obj);
                result = $.parseJSON(obj);
    ...
    $("#editForm").submit(function(e) {
    	...
    	$.ajax({
		type: "POST",
		url: "actions/main_categories/edit.php",
		data: formData,
	    success: function(obj) {
        	result = $.parseJSON(obj);
        	if(result.response == 'y'){
    ...
    $("#tableContainer").on("click", ".updatestatus-element", function() {
        ...
        $.ajax({
            type: "POST",
            url: "actions/main_categories/isactive.php",
            data: {'id': id},
            success: function(obj) {
                result = $.parseJSON(obj);
                if(result.response == 'y')
    ...
    $("#tableContainer").on("click",".remove-element",function(e){
        ...
        if(confirm("Are you sure?")){
            ...
            $.ajax({
                type: "POST",
                url: "actions/main_categories/delete.php",
                data: {'ID':ID},
                //timeout: 3000,
                 success: function(obj) {
                     //alert(obj);
